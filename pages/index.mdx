...
## 📚 O Projeto
- **[Website](!https://paradigma-logico-prolog.vercel.app/)**: explora o paradigma lógico e a linguagem de programação Prolog.
- **[Torre de Hanoi](!https://www.google.com)**: a aplicação feita em prolog recebe a quantidade de discos desejada pelo usuario e resolve o problema mostrando o passo-a-passo.
- **[Cruzadinha](!https://www.google.com)**: testa os conhecimentos do paradigma lógico e de Prolog.
